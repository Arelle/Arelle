...
config = ConformanceSuiteConfig(
    ...
    assets=[
        ConformanceSuiteAssetConfig.conformance_suite(
            Path('XBRL-CONF-2025-01-14.zip'),
            entry_point=Path('XBRL-CONF-2025-01-14/xbrl.xml'),
            public_download_url='https://www.xbrl.org/2025/XBRL-CONF-2025-01-14.zip',
            source=AssetSource.S3_PUBLIC,
        ),
    ],
    expected_additional_testcase_errors={f"XBRL-CONF-2025-01-14/Common/{s}": val for s, val in {

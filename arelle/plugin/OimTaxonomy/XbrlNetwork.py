...
class XbrlNetwork(XbrlTaxonomyObject):
    taxonomy: XbrlTaxonomyType
    name: QName # (required if no extendedTargetName) The name is a QName that uniquely identifies the network object.
...
class XbrlRelationshipType(XbrlTaxonomyObject):
    taxonomy: XbrlTaxonomyType
    name: QName # (required) The name is a QName that uniquely identifies the relationshipType object.
    relationshipTypeURI: QName # (optional) The URI identifies the uri of the relationship type for historical and backward compatibility purposes.
    ...
    sourceObjects: list[QName] # (optional) Defines a list of source object types that can be used as the source for the relationship. The only permitted values are referenceable taxonomy objects
    targetObjects: list[QName] # (optional) Defines a list of target object types that can be used as the source for the relationship. The only permitted values are referenceable taxonomy objects
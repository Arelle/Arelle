...
class XbrlTableTemplate(XbrlReferencableTaxonomyObject):
    ...
    columns: QName # (required) A columns object. (See xbrl-csv specification)
    dimensions: QName # (required) A dimensions object that defines table dimensions. (See xbrl-csv specification)

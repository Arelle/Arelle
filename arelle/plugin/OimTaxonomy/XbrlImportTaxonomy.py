...
class XbrlImportTaxonomy(XbrlTaxonomyObject):
    ...
    def compileSelectStatements(self):
        for selParent in {self} | self.profiles:
            for sel in selParent.selections:

...
qnOimConceptAspect = QName.fromParts("concept")
qnOimLangAspect = QName.fromParts("language")
qnOimPeriodAspect = QName.fromParts("period")
qnOimEntityAspect = QName.fromParts("entity")
qnOimUnitAspect = QName.fromParts("unit")

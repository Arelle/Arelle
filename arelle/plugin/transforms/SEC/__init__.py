...
ballotboxPattern = re_compile(r"^\s*([\u2610-\u2612])\s*$")
...
entityFilerNamePattern = re_compile(r"^\s*(([Ll]arge\s+[Aa]ccelerated\s+[Ff]iler)|([Aa]ccelerated\s+[Ff]iler)|([Nn]on[^\w]+[Aa]ccelerated\s+[Ff]iler))\s*$")

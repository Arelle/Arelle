...
DISCLOSURE_SYSTEM_NL_INLINE_2025_GAAP_OTHER = 'NL-INLINE-2025-GAAP-OTHER-PREVIEW'
DISCLOSURE_SYSTEM_NL_INLINE_MULTI_TARGET = 'NL-INLINE-MULTI-TARGET'

DISCLOSURE_SYSTEM_YEARS = {
    DISCLOSURE_SYSTEM_NL_INLINE_2024: 2024,
    DISCLOSURE_SYSTEM_NL_INLINE_2024_GAAP_OTHER: 2024,
    DISCLOSURE_SYSTEM_NL_INLINE_2025: 2025,
    DISCLOSURE_SYSTEM_NL_INLINE_2025_GAAP_OTHER: 2025,
}

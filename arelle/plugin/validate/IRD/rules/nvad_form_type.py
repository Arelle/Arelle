...
def rule_nvad_e_0080(
    ...
    **kwargs: Any,
    ...
    filers; a tagged value is treated as English when every character is
    ASCII. Values containing any non-ASCII character are Chinese and are
    checked separately by NVAD-E-0090.
    """
...
def rule_nvad_e_0090(
    ...
    **kwargs: Any,
    ...
    non-ASCII character (the English case is checked separately by
    NVAD-E-0080).
    """
    for fact in iterValidNonNilFactsByQname(val.modelXbrl, pluginData.companyNameQn):
        value = (fact.value or "").strip()

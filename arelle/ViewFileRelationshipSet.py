...
from arelle.ModelRenderingObject import ModelRuleDefinitionNode
    ...
    def treeDepth(self, concept, modelObject, indent, arcrole, relationshipSet, visited):
        ...
        if concept not in visited:
            ...
            if isinstance(modelObject, ModelRelationship):
                ...
                elif self.arcrole == "Table-rendering" and isinstance(concept, ModelRuleDefinitionNode):
        ...
        try:
            ...
            if self.arcrole == XbrlConst.parentChild: # extra columns
                ...
                if concept.get("merge") == "true":
                    ...
                    cols.append('')
                cols.append(header)
                if isRelation and isinstance(concept, ModelRuleDefinitionNode):

...
from arelle.arelle_c import ModelObject, ModelConcept
from arelle import ModelDocument, UrlUtil, XbrlConst
...
def checkBaseSet(val, arcrole, ELR, relsSet):
        ...
        for modelRel in relsSet.modelRelationships:
            ...
            if fromConcept is not None and toConcept is not None:
                if not isinstance(fromConcept, ModelConcept) or not fromConcept.isHypercubeItem:
                    modelXbrl.error("xbrldte:HypercubeDimensionSourceError",
                ...
                if not isinstance(toConcept, ModelConcept) or not toConcept.isDimensionItem:
                    modelXbrl.error("xbrldte:HypercubeDimensionTargetError",
    ...
    # check all, notAll relationships
        ...
        for priItemConceptIndex, hcRels in fromRelationships.items():
            priItemConcept = modelXbrl.modelObjects[priItemConceptIndex]
            for hasHcRel in hcRels:
                hcConcept = hasHcRel.toModelObject
                if hcConcept is not None:
                    if not isinstance(priItemConcept, ModelConcept) or not priItemConcept.isPrimaryItem:
                        modelXbrl.error("xbrldte:HasHypercubeSourceError",
                    ...
                    if not isinstance(hcConcept, ModelConcept) or not hcConcept.isHypercubeItem:
                        modelXbrl.error("xbrldte:HasHypercubeTargetError",
                    ...
                    if hcContextElement not in ("segment","scenario"):
                        modelXbrl.error("xbrldte:HasHypercubeMissingContextElementAttributeError",
                    ...
                    if not dimELR:
                        dimELR = ELR
                    hcDimRels = modelXbrl.relationshipSet(
                    ...
                    for hcDimRel in hcDimRels:
                        ...
                        if dimConcept is not None:
                            if arcrole == XbrlConst.all:
                                cntxElt = modelXbrl.qnameDimensionContextElement.setdefault(dimConcept.qname, hcContextElement)
                                if cntxElt != hcContextElement:
                                    modelXbrl.qnameDimensionContextElement[dimConcept.qname] = "ambiguous"
                            domELR = hcDimRel.targetRole
                            if not domELR:
                                domELR = dimELR
                            dimDomRels = modelXbrl.relationshipSet(
                            ...
                            if cycle is not None:
                                ...
                                modelXbrl.error("xbrldte:DRSDirectedCycleError",
                            ...
                            if cycle is not None:
                                if cycle is not None:
                                    ...
                                    path = str(priItemConcept.qname) + " " + " - ".join(
                                        "{0}:{1} {2}".format(rel.modelDocument.basename, rel.sourceline, (rel.toModelObject.qname if isinstance(rel.toModelObject, ModelObject) else None))
                                        for rel in reversed(cycle))
                                modelXbrl.error("xbrldte:PrimaryItemPolymorphismError",
        ...
        for modelRel in relsSet.modelRelationships:
            ...
            if fromConcept is not None and toConcept is not None:   # none if failed to load
                if not isinstance(fromConcept, ModelConcept) or not fromConcept.isDimensionItem:
                    modelXbrl.error("xbrldte:DimensionDomainSourceError",
                ...
                if not isinstance(toConcept, ModelConcept) or not toConcept.isDomainMember:
                    modelXbrl.error("xbrldte:DimensionDomainTargetError",
    ...
    # check dimension-default relationships
        ...
        for modelRel in relsSet.modelRelationships:
            ...
            if fromConcept is not None and toConcept is not None:
                if not isinstance(fromConcept, ModelConcept) or not fromConcept.isDimensionItem:
                    modelXbrl.error("xbrldte:DimensionDefaultSourceError",
                    ...
                    modelXbrl.error("xbrldte:DimensionDefaultSourceError",
                        ...
                        modelObject=modelRel, source=fromConcept.qname, target=toConcept.qname, linkrole=ELR)
                if not isinstance(toConcept, ModelConcept) or not toConcept.isDomainMember:
                    modelXbrl.error("xbrldte:DimensionDefaultTargetError",
                        _("Dimension-default relationship from %(source)s to %(target)s in link role %(linkrole)s must have a domain member target"),
                        modelObject=modelRel, source=fromConcept.qname, target=toConcept.qname, linkrole=ELR)
                if fromConcept in modelXbrl.dimensionDefaultConcepts and toConcept != modelXbrl.dimensionDefaultConcepts[fromConcept]:
                    modelXbrl.error("xbrldte:TooManyDefaultMembersError",
                        ...
                        target2=modelXbrl.dimensionDefaultConcepts[fromConcept].qname)
                else:
                    modelXbrl.dimensionDefaultConcepts[fromConcept] = toConcept
                    modelXbrl.qnameDimensionDefaults[fromConcept.qname] = toConcept.qname

    # check for primary item cycles
    elif arcrole == XbrlConst.domainMember:
        fromRelationships = relsSet.fromModelObjects()
        for priItemConceptIndex, rels in fromRelationships.items():
            priItemConcept = modelXbrl.modelObjects[priItemConceptIndex]
            for domMbrRel in rels:
                ...
                if toConcept is not None:
                    if not isinstance(priItemConcept, ModelConcept) or not priItemConcept.isDomainMember:
                        modelXbrl.error("xbrldte:DomainMemberSourceError",
                    ...
                    if not isinstance(toConcept, ModelConcept) or not toConcept.isDomainMember:
                        modelXbrl.error("xbrldte:DomainMemberTargetError",
    ...
    if concept.get("{http://xbrl.org/2005/xbrldt}typedDomainRef"):
        if concept.isDimensionItem:
            ...
            if typedDomainElement is None:
                ...
                if url == "": # same document reference
                    url = concept.modelDocument.url
                if len(id) == 0:
                ...
                elif url not in val.modelXbrl.urlDocs:
                    val.modelXbrl.error("xbrldte:OutOfDTSSchemaError",
                        _("Concept %(concept)s typedDomainRef is not resolved"),
                        modelObject=concept, concept=concept.qname)
                else:  # reference to a schema ID which wasn't found among schema global concept elements or otherwise not found

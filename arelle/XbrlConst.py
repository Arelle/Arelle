...
# 2011 table linkbase
table = "http://xbrl.org/2012/table"
table2011 = "http://xbrl.org/2011/table"
tableBreakdown = "http://xbrl.org/arcrole/2012/table-breakdown"
tableAxis2011 = "http://xbrl.org/arcrole/2011/table-axis"
tableFilter = "http://xbrl.org/arcrole/2012/table-filter"
tableFilter2011 = "http://xbrl.org/arcrole/2011/table-filter"
tableDefinitionNodeSubtree = "http://xbrl.org/arcrole/2012/definition-node-subtree"
...
tableTupleContent = "http://xbrl.org/arcrole/2012/tuple-content"
tableTupleContent2011 = "http://xbrl.org/arcrole/2011/axis/tuple-content"
tableDefinitionNodeMessage = "http://xbrl.org/arcrole/2012/definition-node-message"
tableDefinitionNodeSelectionMessage = "http://xbrl.org/arcrole/2012/definition-node-selection-message"
tableAxisMessage2011 = "http://xbrl.org/arcrole/2012/axis-message"
tableAxisSelectionMessage2011 = "http://xbrl.org/arcrole/2012/axis-selection-message"
qnTableTable = qname("{http://xbrl.org/2012/table}table:table")
qnTableTable2011 = qname("{http://xbrl.org/2011/table}table:table")
qnTableCompositionNode = qname("{http://xbrl.org/2012/table}table:compositionNode")
qnTableCompositionAxis2011 = qname("{http://xbrl.org/2011/table}table:compositionAxis")
qnTableFilterNode = qname("{http://xbrl.org/2012/table}table:filterNode")
qnTableFilterAxis2011 = qname("{http://xbrl.org/2011/table}table:filterAxis")
qnTableConceptRelationshipNode = qname("{http://xbrl.org/2012/table}table:conceptRelationshipNode")
qnTableConceptRelationshipAxis2011 = qname("{http://xbrl.org/2011/table}table:conceptRelationshipAxis")
qnTableDimensionRelationshipNode = qname("{http://xbrl.org/2012/table}table:dimensionRelationshipNode")
qnTableDimensionRelationshipAxis2011 = qname("{http://xbrl.org/2011/table}table:dimensionRelationshipAxis")
qnTableRuleNode = qname("{http://xbrl.org/2012/table}table:ruleNode")
qnTableRuleAxis2011 = qname("{http://xbrl.org/2011/table}table:ruleAxis")
qnTableClosedDefinitionNode = qname("{http://xbrl.org/2012/table}table:closedDefinitionNode")
qnTablePredefinedAxis2011 = qname("{http://xbrl.org/2011/table}table:predefinedAxis")
qnTableSelectionNode = qname("{http://xbrl.org/2012/table}table:selectionNode")
qnTableSelectionAxis2011 = qname("{http://xbrl.org/2011/table}table:selectionAxis")
qnTableTupleNode = qname("{http://xbrl.org/2012/table}table:tupleNode")

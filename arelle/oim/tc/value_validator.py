...
from arelle.oim.tc.xs_dates import XsInstant
...
from arelle.oim.tc.periods import PERIOD_TYPE_PARSERS, parse_period, period_time_zone_matches
from arelle.oim.tc.metadata.types import (
    CORE_ENTITY,
    CORE_LANGUAGE,
    CORE_PERIOD,
    CORE_UNIT,

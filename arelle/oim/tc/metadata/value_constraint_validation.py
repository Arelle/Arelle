...
from arelle.oim.tc.metadata.common import TCMetadataValidationError
from arelle.oim.tc.metadata.model import TCValueConstraint
from arelle.oim.tc.metadata.restrictions import (
    BOUNDS_RESTRICTIONS,
    TCRestriction,
    get_constraint_values_by_restriction,
    permitted_restrictions,
)
from arelle.oim.tc.metadata.types import resolve_effective_lexical_type
from arelle.oim.tc.periods import PERIOD_TYPES

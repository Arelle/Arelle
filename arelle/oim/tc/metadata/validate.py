...
from arelle.oim.tc.metadata.keys_validation import validate_keys
from arelle.oim.tc.metadata.model import TCMetadata
from arelle.oim.tc.metadata.value_constraint_validation import validate_value_constraint

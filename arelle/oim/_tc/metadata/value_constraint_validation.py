...
def validate_value_constraint(
    ...
    if constraint.period_type is not None and constraint.type != "period":
        yield _illegalConstraintError(_("periodType is not applicable to type '{type}'").format(type=constraint.type))
